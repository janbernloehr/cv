...
export const RESUME_DATA = {
  ...
  work: [
    {
      company: "Bosch, Level 4 driving project, Stuttgart-Vaihingen",
  ...
  skills: [
    ...
    "Tensorflow",
    "Computer Vision",
    "Data Loop", "Object Detection & Tracking", "Auto labeling", "E2E Deep Learning",
    "Python",
    "Azure",
    "CUDA",
    "Modern C++",
